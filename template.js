...
t.prototype.getScale = function(row) {
	...
	obj.name = obj["Scale name"] || obj["For Continuous: units of measurement"] || obj["For Discrete: Name of scale or units of measurement"] || obj["For Categorical: Name of rating scale"];
