		...
		value: function build_searchbar() {
			...
			if (settings.general.search.visible) {
				...
				if (page == "home") {
					...
					$("body").append($('<section>', { "id": "navbar", "class": "container" }).append($('<div>', { "class": "row" }).append($('<div>', { "id": "breadcrumb", "class": "col s6 m4 l6" }).append($breadcrumbs)).append($('<div>', { "id": "searchbar", "class": "col s6 m8 l6" }).append($searchbar))));
				}
			}
		}
