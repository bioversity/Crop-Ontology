...
module.exports={
    "general": {
        ...
        "footer": {
            ...
            "description": "Some identities data<br />such as address, informations, etc...",
            "visible": true
        },
        "license": {
...
},{"../../src/js/_obj.es6":9,"../../src/js/layout.es6":13}],5:[function(require,module,exports){
...
var layout = function () {
	...
	_createClass(layout, [{
		...
		value: function activate() {
			...
			$("#static_contents a, .license a").each(function () {
				// Compare the anchor tag's host name with location's host name
				return _this.hostname && _this.hostname !== location.hostname;
    ...
    */
     ...
     */
				if (page == "home") {
					...
					// Loader
					// ---------------------------------
					$('<div>', { "class": "help" }).append($('<div>', { "class": "center-align" }).text(settings.general.loader.text)).append(_this2.loader({ type: "progress" }))
					// ---------------------------------
